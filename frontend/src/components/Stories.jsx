    ...
    <section className="py-20 md:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          ...
          <Link to="/blog" className="text-[#0b7285] font-semibold hover:text-[#f4623a] transition-colors self-start md:self-end">
            ...
            <article key={p.id} className="group cursor-pointer">
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden mb-5 owa-card shadow-[0_10px_30px_-15px_rgba(11,33,61,0.15)]">
                ...
                <div className="absolute top-4 left-4">
                  <span className="px-3 py-1 rounded-md bg-white/95 text-[11px] font-bold tracking-wider text-[#0b7285]">{p.category}</span>
                </div>
              ...
              <h3 className="text-xl font-semibold text-[#14213d] group-hover:text-[#0b7285] transition-colors leading-snug" style={{ fontFamily: 'Manrope' }}>
                {p.title}
              </h3>
