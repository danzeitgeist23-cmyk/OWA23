    ...
    <section className="py-20 md:py-28 bg-[#f7f9fb]">
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          <div>
            <p className="text-[#f4623a] text-sm font-semibold tracking-widest uppercase mb-2">Inspiration</p>
          ...
          <Link to="/actividades" className="text-[#0b7285] font-semibold hover:text-[#f4623a] transition-colors self-start md:self-end">
