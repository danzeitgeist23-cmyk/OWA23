    ...
    <div className="pt-24 pb-20 bg-white">
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center py-16">
          <div>
            <p className="text-[#f4623a] text-sm font-semibold tracking-widest uppercase mb-3">Sobre OWA</p>
            <h1 className="text-4xl md:text-6xl font-bold text-[#14213d] leading-tight" style={{ fontFamily: 'Playfair Display' }}>
            ...
            <div className="grid grid-cols-2 gap-6 mt-10">
              {stats.map((s, i) => (
                <div key={i}>
                  <div className="text-4xl font-bold text-[#0b7285]" style={{ fontFamily: 'Playfair Display' }}>{s.number}</div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-[#f4623a] rounded-xl px-6 py-4 text-white shadow-xl">
        ...
        <div className="py-16">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <p className="text-[#f4623a] text-sm font-semibold tracking-widest uppercase mb-2">Nuestros valores</p>
            <h2 className="text-3xl md:text-5xl font-bold text-[#14213d]" style={{ fontFamily: 'Playfair Display' }}>Lo que nos <span className="italic font-medium">mueve</span></h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="p-8 rounded-2xl border border-gray-100 hover:border-[#0b7285] hover:shadow-[0_20px_40px_-20px_rgba(11,33,61,0.2)] transition-all">
                <div className="w-12 h-12 rounded-full bg-[#0b7285]/10 flex items-center justify-center mb-4">
                  <v.icon className="w-5 h-5 text-[#0b7285]" />
                </div>
                <h3 className="text-xl font-semibold mb-2 text-[#14213d]" style={{ fontFamily: 'Manrope' }}>{v.title}</h3>
