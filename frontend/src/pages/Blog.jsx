            ...
            <Link key={p.id} to={`/blog/${p.id}`} className="block">
              <article className="group cursor-pointer h-full">
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden mb-5 owa-card shadow-[0_10px_30px_-15px_rgba(11,33,61,0.15)]">
                  ...
                  <span className="absolute top-4 left-4 px-3 py-1 rounded-md bg-white/95 text-[11px] font-bold tracking-wider text-[#1fa5a3]">{p.category}</span>
                ...
                <h3 className="text-xl font-semibold text-[#14213d] group-hover:text-[#1fa5a3] leading-snug">{p.title}</h3>
